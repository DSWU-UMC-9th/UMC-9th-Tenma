...
public enum GeneralErrorCode implements BaseErrorCode{
    ...
    // Auth
    AUTH_EMAIL_DUPLICATED(HttpStatus.BAD_REQUEST, "AUTH400_1", "이미 사용 중인 이메일입니다."),
    AUTH_INVALID_PASSWORD(HttpStatus.BAD_REQUEST, "AUTH400_2", "비밀번호가 올바르지 않습니다."),
    AUTH_LOGIN_FAILED(HttpStatus.UNAUTHORIZED, "AUTH401_1", "이메일 또는 비밀번호가 잘못되었습니다."),
    AUTH_NOT_LOGGED_IN(HttpStatus.UNAUTHORIZED, "AUTH401_2", "로그인이 필요한 요청입니다."),
    AUTH_FORBIDDEN(HttpStatus.FORBIDDEN, "AUTH403_1", "권한이 없습니다."),
    ;
